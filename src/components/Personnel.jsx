    ...
    <div className="grid md:grid-cols-3 gap-x-6 lg:gap-x-12">
      <div className="mb-5 lg:mb-0">
        <div className="bg-white block rounded-lg shadow-lg">
          ...
          <div className="p-6">
            <h5 className="text-lg font-bold mb-4">Pr Fouda Pierre</h5>
            <p className="text-gray-500 mb-4">Urologue</p>
      ...
      <div className="mb-6 lg:mb-0">
        <div className="bg-white block rounded-lg shadow-lg">
          ...
          <div className="p-6">
            <h5 className="text-lg font-bold mb-4">Pr Ongolo Pierre</h5>
            <p className="text-gray-500 mb-4">Radiologue</p>
            <ul className="list-inside flex mx-auto justify-center">
              <a href="#!" className="px-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" className="w-4 h-4 text-blue-600">
                  <path fill="currentColor"
      ...
      <div className="">
        <div className="bg-white block rounded-lg shadow-lg">
          ...
          <div className="p-6">
            <h5 className="text-lg font-bold mb-4">Dr Bwelle georges</h5>
            <p className="text-gray-500 mb-4">Chirurgien</p>
            <ul className="list-inside flex mx-auto justify-center">
            <a href="#!" className="px-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 512" className="w-4 h-4 text-blue-600">
                  <path fill="currentColor"
